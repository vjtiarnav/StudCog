...
class OfficialSignUpScreen extends StatefulWidget {
  const OfficialSignUpScreen({Key? key}) : super(key: key);

  @override
  _OfficialSignUpScreenState createState() => _OfficialSignUpScreenState();
}
            ...
            child: Column(
              children: <Widget>[
               ...
               /* reusableTextField("Enter UserName", Icons.person_outline, false,
                ...
                reusableTextField("Enter College Email Id", Icons.email_outlined, false,
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => OfficialHomeScreen()));
                  },
                  style: ButtonStyle(
