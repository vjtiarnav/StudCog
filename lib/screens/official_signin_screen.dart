...
import 'package:inheritance/screens/official_home_screen.dart';
import 'package:inheritance/screens/official_signup_screen.dart';
...
class OfficialSignInScreen extends StatefulWidget {
  const OfficialSignInScreen({Key? key}) : super(key: key);

  @override
  _OfficialSignInScreenState createState() => _OfficialSignInScreenState();
}

class _OfficialSignInScreenState extends State<OfficialSignInScreen> {
                  ...
                  try {
                    FirebaseAuth.instance
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => OfficialHomeScreen()));
                    });
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => OfficialSignUpScreen()));
          },
          child: const Text(
            " Sign Up",
